...
<div class ="w3-header w3-center w3-padding w3-animate-opacity">
        <img src='../images/geomodel_grave_mapping_2.png' alt='' 
        style='width:50%;'>
...
<form method="POST" action="SearchCemetery.php">
  ...
  foreach ($rows as $cemeterys) {
    ...
    echo "<a href='GraveDetails.php?cmid=$cmid ' style='text-decoration: none;'> <img class='w3-image' src='$image_path'width='150' height='70'" .
      "onerror=this.onerror=null; this.src='../res/background.png'"
      . "style='width:100%;height:250px'></a><hr>";

    echo "<header class='w3-container w3-center' style='background-color: #133764 ; color:white'><h5><b>{$Name_Deceased}</b></h5><h4><b>Age <br>{$Years_Buried}</b></h4>
    <h4><b>Section : {$Section}</b></h4></header>";
...
<br>
  ...
  <ul class="pagination-list">
    ...
    for ($page = 1; $page <= $number_of_page; $page++) {
      ...
      echo '"><a href="SearchCemetery.php?pageno=' . $page . '" aria-label="Page ' . $page . '">' . $page . '</a></li>';
    }
    ?>
  </ul>
</nav>
